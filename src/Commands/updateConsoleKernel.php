...
class UpdateConsoleKernel extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ratech-admin:update-console-kernel';
     ...
     * @var string
     */
    protected $description = 'Update Console Kernel';
    ...
    public function handle()
    {
        ...
        $setting = [
            ...
            'search' => '//          ->hourly();',
            'stub' => __DIR__ . '/../../stubs/Console/Kernel.stub',
        ];
